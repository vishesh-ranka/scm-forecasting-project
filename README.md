...
The final **28 days** of history are hidden from the models and kept aside to test against. That horizon matches the one the original M5 competition scored on.
